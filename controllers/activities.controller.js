...
const { ImageSlider, EventDetail } = require('../models')
 ...
 */
exports.getImageSlider = async (_req, res) => {
  ImageSlider.find({})
    .then((docs) => {
 ...
 * @param {e.Response} res
 */
exports.postImageSlider = async (req, res) => {
 ...
 * @param {e.Response} res
 */
exports.updateUpcomingWithoutImage = async (req, res) => {
  const file = req.body.file
 ...
 * @param {e.Response} res
 */
exports.updateUpcomingWithImage = async (req, res) => {
  const file = req.body.file
  file.buffer = Buffer.from(file.buffer, 'base64')
  file.buffer = Buffer.from(file.buffer, 'utf8')
  const link = req.body.url
 ...
 * @param {e.Response} res
 */
exports.postEventDetail = async (req, res) => {
  const file = req.body.file
  file.buffer = Buffer.from(file.buffer, 'base64')
  file.buffer = Buffer.from(file.buffer, 'utf8')
 ...
 * @param {e.Response} res
 */
exports.getRecentEventDetail = async (_req, res) => {
 ...
 * @param {e.Response} res
 */
exports.getEventDetail = async (_req, res) => {
  EventDetail.find({})
    .then((docs) => {
      res.status(200).send(docs)
    })
 ...
 * @param {e.Response} res
 */
exports.getEventDetailWorkshop = async (_req, res) => {
 ...
 * @param {e.Response} res
 */
exports.getEventDetailTechbhukkads = async (_req, res) => {
 ...
 * @param {e.Response} res
 */
exports.getEventDetailFarewell = async (_req, res) => {
 ...
 * @param {e.Response} res
 */
exports.updateEventWithoutImage = async (req, res) => {
 ...
 * @param {e.Response} res
 */
exports.updateEventWithImage = async (req, res) => {
  const file = req.body.file
  file.buffer = Buffer.from(file.buffer, 'base64')
  file.buffer = Buffer.from(file.buffer, 'utf8')
