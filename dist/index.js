...
exports.$.use(express_1.json());
exports.$.use(morgan_1.default('dev'));
...
exports.$.use(routes_1.default);
exports.$.all('*', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        res.status(404).send({
            status: false,
            data: 'page not found',
